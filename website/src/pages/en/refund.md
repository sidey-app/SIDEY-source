...
originalLabel: View the original document
---
...
A full refund will be issued when a legally recognized reason is confirmed, including:

- payment was approved but the Digital Entitlement was not delivered;
- the delivered item does not match its description or the purchase contract;
- the same order or item was charged more than once;
- the payment was not authorized by the Account holder;
- a minor made a purchase without consent required from a legal representative; or
- applicable law otherwise requires a full refund.
...
Deleting a SIDEY Account is not a purchase refund request. A valid Apple in-app purchase may still be restored to a new SIDEY Account using the same Apple purchasing account.

## Records and statutory rights

Refund requests and outcomes are retained securely for the period needed to resolve disputes and meet legal obligations. This Policy does not limit cancellation, termination, or remedy rights guaranteed by applicable law.

## Support

- **Seller:** 싸이디(SIDEY)
- **Email:** <ryu200112@gmail.com>
- **Business registration number:** 388-53-01259
