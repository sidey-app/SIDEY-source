...
export const releases = {
  windows: {
    ...
    url: `https://github.com/sidey-app/SIDEY/releases/download/windows-v${windowsRelease.releaseVersion}/SIDEY-Windows-x64-v${windowsRelease.releaseVersion}-Setup.exe`,
    notes: `https://github.com/sidey-app/SIDEY/releases/tag/windows-v${windowsRelease.releaseVersion}`,
